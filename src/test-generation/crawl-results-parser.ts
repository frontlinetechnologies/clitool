 ...
 * Reuses patterns from documentation/crawl-results-parser.ts.
 */
  ...
  try {
    ...
    if (!jsonData.summary || !jsonData.pages) {
      throw createTestGenerationError(
        TestGenerationErrorType.VALIDATION_ERROR,
    ...
    if (error instanceof SyntaxError) {
      throw createTestGenerationError(
        TestGenerationErrorType.PARSE_ERROR,
    ...
    throw createTestGenerationError(
      TestGenerationErrorType.INVALID_INPUT,
